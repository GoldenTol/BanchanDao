	...
	<div class="container mt-3 col-md-5">
		...
		<form action="<%=withFormTag%>" method = "post" enctype="multipart/form-data">
			...
			<input type="text" name="deleteImage01" value="${requestScope.bean.image01}">
				<span class="input-group-text col-md-2">이미지01</span><!-- 이미지 수정으로인해 삭제될 기존 이미지를 넘 길 파라미터 만들기 -->
			...
			<div class="input-group">
				...
				<input id="kcal" name="kcal" type="number" class="form-control" placeholder="" value="${requestScope.bean.kcal}">
			</div>			
			...
			<div class="input-group">
				...
				<input id="remark" name="remark" type="text" disabled="disabled" class="form-control" placeholder="" value="${requestScope.bean.remark}">
			
			</div>
			<div class="input-group">
				<span class="input-group-text col-md-2">유통 기한</span> 
				<input id="limtdate" name="limtdate" type="datetime" class="form-control" placeholder="" value="${requestScope.bean.limtdate}">
			</div>	
