...
<!-- Hero -->
  <hr style="width: 70%; height: 5px; border: none; background-color: gray; margin: auto;">
  <section class="et-hero-tabs">
				...
				<tr>
					...
					<td class="col-lg-5">
						<div class="card leftside card_borderless" style="width: 40rem;">
							<h1 style="font-size: 40px; font-weight: 600;">${bean.name}</h1>
							...
							<form action="<%=withFormTag%>" method="post">
								<ul class="pagination">
									...
									<li class="page-item"><a class="page-link" href="#"> <input
											type="hidden" name="command" value="maInsert"> <input
											type="hidden" name="num" value="${bean.num}"> <input
											type="hidden" name="stock" value="${bean.stock}"> <input
								...
								<div class="btn-group">
									...
									<button type="submit" class="btn btn-primary rightnow">바로
										구매</button>
								</div>
							</form>
						</div>
    ...
    <div class="et-hero-tabs-container">
      <a class="et-hero-tab" href="#tab-detail">상품 정보</a>
      <a class="et-hero-tab" href="#tab-review">리뷰 작성</a>
      <a class="et-hero-tab" href="#tab-bolist">1대1 문의</a>
      <a class="et-hero-tab" href="#tab-reviewContent">리뷰 리스트</a>
  ...
  <main class="et-main">
  	<hr style="width: 70%; height: 5px; border: none; background-color: gray; margin: auto;">
    <section class="et-slide" id="tab-detail">
      	<%-- 상품 상세 보기 --%>
		
		<h2>상품 상세</h2>
		<p>탐나는밥상 마라탕</p>
		<img src="<%=imagefiles%>/image/탐나는 마라탕.jpg" class="rounded"
			alt="Cinque Terre" width="1200" height="6000">
    </section>
    <section class="et-slide" id="tab-review">
      	<%-- 리뷰 작성 위치. --%>
		<hr
				style="width: 70%; height: 5px; border: none; background-color: gray; margin: auto;">
			<div class="container mt-3">
					...
					<tbody>
						<form action="<%=withFormTag%>" method="post">
							<input type="hidden" name="command" value="reInsert"> <input
								type="hidden" name="num" value="${bean.num}"> <input
								type="hidden" name="category" value="${bean.category}">
							<tr>
								<td class="col-lg-2" valign="middle" align="right">제목</td>
							...
							<tr>
								<td class="col-lg-2" align="right">댓글</td>
								<td class="col-lg-8">
									<div class="card leftside card_borderless" style="width: 15cm;">
							...
							<tr>
								<td class="col-lg-2" align="right" valign="middle">이미지</td>
								<td class="col-lg-8"><input type="file" name="image01"
									id="image01"></td>
								<td class="col-lg-2"></td>
							</tr>
							<tr>
								<td class="col-lg-2" align="right" valign="middle">평점</td>
								<td class="col-lg-8"><input type="text" name="grade"
									id="grade" placeholder="0~10 사이값 넣어주세요."></td>
								<td class="col-lg-2">
									<div class="card leftside card_borderless" style="width: 5cm;">
										<button type="submit" class="btn btn-info"
											onclick="return validCheak();">저장하기</button>
									</div>
								</td>
							</tr>
						</form>
    ...
    <section class="et-slide" id="tab-bolist">
      <hr
			style="width: 70%; height: 5px; border: none; background-color: gray; margin: auto;">
		<div class="container mt-3">
			<h2 class="h2">1대1 문의</h2>
				...
				<tbody>
					<form action="<%=withFormTag%>" method="post">
						...
						<input type="hidden" name="name"
							value="${sessionScope.loginfo.name}"> <input type="hidden"
							name="command" value="boInsert"> <input id="no" name="no"
							type="hidden" class="form-control" placeholder=""> <input
							id="writer" name="writer" type="hidden" class="form-control"
							value="${sessionScope.loginfo.id}" placeholder="">
						...
						<tr>
							<td class="col-lg-2" align="right">문의 내용</td>
							<td class="col-lg-8">
								<div class="card leftside card_borderless" style="width: 15cm;">
						...
						<input id="regdate" name="regdate" type="hidden"
							class="form-control" value="${regdate}" placeholder="">
						<tr align="right">
							<td class="col-lg-2" align="right">
								<div class="card leftside card_borderless" align="right"
									style="width: 5cm;">
    ...
    <section class="et-slide" id="tab-reviewContent">
      <%-- 상품 리뷰 항목. --%>
		<hr
			style="width: 70%; height: 5px; border: none; background-color: gray; margin: auto;">
		<div class="container mt-3">
			<details style="">
				...
				<c:forEach var="bean" items="${lists}" varStatus="status">
					...
					<hr
						style="width: 100%; height: 5px; border: none; margin: gray; background-color: black;">
				</c:forEach>
			</details>
		</div>
    </section>
