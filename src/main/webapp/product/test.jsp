...
<!-- Hero -->
  <section class="et-hero-tabs">
				...
				<td class="col-lg-5">
					<div class="card leftside card_borderless">
						...
						<form action="<%=withFormTag%>" method="post">
							<ul class="pagination">
								<li class="page-item">
									<a class="page-link minus" href="#">-</a>
								</li>
								<li class="page-item">
    ...
    <div class="et-hero-tabs-container">
      <a class="et-hero-tab" href="#tab-es6">상품 정보</a>
      <a class="et-hero-tab" href="#tab-flexbox">리뷰 작성</a>
      <a class="et-hero-tab" href="#tab-react">1대1 문의</a>
      <a class="et-hero-tab" href="#tab-angular">리뷰 리스트</a>
			...
			<table class="table">
				...
				<tbody>
					<form action="<%=withFormTag%>" method="post">
						...
						<tr>
							<td class="col-lg-2" align="right" valign="middle"></td>
