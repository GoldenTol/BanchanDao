...
public class BoardReDetailController extends SuperClass{
	@Override
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(loginfo.getId().equals(bean.getBoReWriter())==false) {
				cnt = dao.UpdateReadhit(boReNo);
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		if(bean==null){
			...
			super.GotoPage("board/boReDetailForm.jsp"); 
		}
	}
}
